...
class Config:
    ...
    SCHEDULED_JOB_INTERVAL_SECONDS = int(os.environ.get('SCHEDULED_JOB_INTERVAL_SECONDS', '15'))
    SCHEDULED_JOB_MAX_INSTANCES = int(os.environ.get('SCHEDULED_JOB_MAX_INSTANCES', '2'))
